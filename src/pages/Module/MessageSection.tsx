...
import chatVideo from "../../assets/animations/Chat.webm";
  ...
  return (
    <AnimatePresence mode="wait">
      {showSub ? (
        ...
        >
          {/* ══ DESKTOP ══ */}
          <div className="hidden md:flex items-end  px-12 lg:px-20 xl:px-28 overflow-visible">
            {/* Left text */}
            <M.div
            ...
            >
              <video
                ...
                className="w-full h-full object-contain object-bottom mb-0 md:mb-20"
              />
            </M.div>
          </div>
            ...
            <div className="relative z-10 flex flex-col items-center text-white text-center flex-1">
              ...
              >
                <p
                  ...
                  dangerouslySetInnerHTML={{ __html: t("sections.message.mobile_desc") }}
                />
