...
import chatVideo from "../../assets/animations/AIFinanzas.webm";
            ...
            <div className="relative z-10 flex flex-col items-center text-white text-center flex-1">
              ...
              >
                <p
                  ...
                  dangerouslySetInnerHTML={{ __html: t("sections.ai_finance.mobile_desc") }}
                />
